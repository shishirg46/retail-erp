...
export const queryKeys = {
  ...
  purchases: {
    ...
    list: (paymentType?: string, supplierId?: string, cursor?: string) =>
      [...queryKeys.purchases.all, "list", { paymentType, supplierId, cursor }] as const,
    detail: (id: string) => [...queryKeys.purchases.all, id] as const,
  },
} as const;
